...
// --- classes 테이블에서 수업 목록 가져오기 (필요한 컬럼만) ---
$classes = [];
try {
    // class_duration, teacher_name, room_number 컬럼 제외
...
if ($is_logged_in) {
    try {
        // c.class_duration, c.teacher_name, c.room_number 컬럼 제외
        ...
        <div class="main-container">
                ...
                <table id="classesTable">
                    ...
                    <tbody>
                        <script>
                            ...
                            const FIXED_CLASS_DURATION = 2; // 수업 지속 시간 2시간 고정
                        </script>
                    </tbody>
                </table>
            </div>
            ...
            <div class="timetable-section">
                ...
                <div id="selectedClassInfo" style="display: none;">
                    ...
                    <p>授業コマ数: <span id="currentSelectedClassDuration">2</span>コマ</p> <button id="addSelectedClassBtn">選択した授業を時間割に追加</button>
                </div>
